...
/**
 * struct mystruct - variables -args, file, line linecontent
 * @arg: value
 * @file: pointer to monty file
 * @linecontent: line linecontent
 * @mystack: flag change stack <-> queue
...
extern my_data_type dataHolder;
...
int execute(char *linecontent, stack_t **head, unsigned int counter, FILE *file);
...
void generate_node(stack_t **head, int n);
